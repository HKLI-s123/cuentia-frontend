...
// Datos simulados de gastos por proveedor
export const providersExpenses = [
  { id: 1, name: 'Proveedor A', rfc: 'XEXX010101000', gastos: 95000, porcentaje: 40, status: 'Activo', statusVariant: 'success' },
  { id: 2, name: 'Proveedor B', rfc: 'AAA020202AAA', gastos: 72000, porcentaje: 30, status: 'Pendiente', statusVariant: 'warning' },
  { id: 3, name: 'Proveedor C', rfc: 'BBB020202BBB', gastos: 42000, porcentaje: 20, status: 'Activo', statusVariant: 'success' },
  { id: 4, name: 'Proveedor D', rfc: 'CCC020202CCC', gastos: 28000, porcentaje: 10, status: 'Inactivo', statusVariant: 'danger' }
]

export const mainExpenses = [
  { id: 1, category: 'Nomina', amount: 120000 },
  { id: 2, category: 'Renta', amount: 45000 },
  { id: 3, category: 'Servicios', amount: 28000 },
  { id: 4, category: 'Marketing', amount: 22000 },
  { id: 5, category: 'Papelería y Otros', amount: 8000 }
]

export const mainRevenue = [
  { id: 1, category: 'Ventas Nacionales', amount: 180000 },
  { id: 2, category: 'Exportaciones', amount: 95000 },
  { id: 3, category: 'Servicios Profesionales', amount: 60000 },
  { id: 4, category: 'Arrendamientos', amount: 35000 },
  { id: 5, category: 'Otros Ingresos', amount: 15000 }
]


export const clientsRevenue: ClientRevenue[] = [
  {
    id: 1,
    name: 'Cliente A',
    rfc: 'XAXX010101000',
...
export const financeTrendsData: StatCardProps[] = [
  {
    value: 152,
    percentage: 12.5,
    percentageIcon: <TbArrowUp className="text-success" />,
    title: 'CFDIs recibidos en el período',
    progress: 12.5
  },
  {
    value: 138,
    ...
    title: 'CFDIs válidos para deducción',
    progress: 8.2
  },
  {
    value: 485000,
...
export const getClientRevenueChartOptions = (): EChartsOption => ({
  tooltip: {
    trigger: 'item',
  ...
  series: [
    {
      ...
      data: clientsRevenue.map(client => ({
...
export const getFinanceStatsOptions = (): EChartsOption => {
  ...
  for (let i = -14; i <= 0; i++) {
    ...
    const ingreso = Math.floor(Math.random() * 2000) + 1000;
    const egreso = Math.floor(Math.random() * 1500) + 500;
    const profit = ingreso - egreso;

    ingresos.push(ingreso);
    egresos.push(egreso);
    utilidad.push(profit);
  }
    ...
    tooltip: {
      ...
      formatter: function (params: any) {
        ...
        const seriesInfo = params
          .map((item: any) => {
            return `${item.marker} ${item.seriesName}: <span class="fw-bold">$${item.value}</span>`;
          })
          .join("<br/>");
    ...
    series: [
      {
        ...
        type: "line",
        smooth: true,
        itemStyle: { color: getColor("success") }, // Verde
        showAllSymbol: true,
        symbol: "circle",
        symbolSize: 5,
        data: ingresos,
      },
      {
        ...
        type: "line",
        smooth: true,
        itemStyle: { color: getColor("danger") }, // Rojo
        showAllSymbol: true,
        symbol: "circle",
        symbolSize: 5,
        data: egresos,
