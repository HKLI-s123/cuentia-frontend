...
export const menuItems: MenuItemType[] = [
    ...
    {key: 'servicios', label: 'servicios', isTitle: true},
    {
        ...
        icon: TbUsers,
        children: [
            {key: 'listado-clientes', label: 'Administrar', url: '/dashboard/clientes'},
        ]
    },
    {
        key: 'chatcontable',
    ...
    {key: 'herramientas', label: 'Herramientas', isTitle: true},
    {
        key: 'cfdis', label: 'CFDIs', icon: TbFileCertificate,
        children: [
            {key: 'listado-facturas', label: 'Listado de facturas', url: '/dashboard/facturas'},
            {key: 'complementos', label: 'Ver Complementos', url: '/dashboard/complementos'},
            {key: 'notascredito', label: 'Ver Notas de Credito', url: '/dashboard/notas_credito'},
            {key: 'diot', label: 'Generar DIOT', url: '/dashboard/diot'},
        ]
    },
    {
        key: 'automatizacion', label: 'Automatización', icon: TbAutomation,
        children: [
            {key: 'reporte-gastos', label: 'Reporte de gastos', url: '/dashboard/reporte-gastos'},
            {key: 'comprobantes-automaticos', label: 'Comprobantes digitales', url: '/dashboard/comprobantes-digitales'},
        ]
    },
