...
const Customizer = () => {
    ...
    const {
        ...
        changeSideNavColor,
        changeSideNavSize,
        position, changeLayoutPosition, toggleSideNavUser, reset
    } = useLayoutContext()

    return (
        <Offcanvas show={customizer.isOpen} onHide={customizer.toggle} placement="end" className="overflow-hidden">
            <div
              className="d-flex justify-content-between gap-2 p-3 text-white"
              style={{
            ...
            >
                <div>
                    <h5 className="mb-1 fw-bold text-white text-uppercase">Personalización del Panel</h5>
                    <p className="text-white text-opacity-75 fst-italic fw-medium mb-0">Ajusta la apariencia y comportamiento del sistema según tu preferencia.</p>
                </div>
            ...
            <SimpleBar className="offcanvas-body p-0 h-100">
                <div className="p-3 border-bottom border-dashed">
                    <h5 className="mb-3 fw-bold">Estilo de interfaz</h5>
                    <Row className="g-3">
                        {
                            skinOptions.map((item, idx) => (
                                <Col sm={6} key={idx}>
                                    <div className="form-check card-radio">
                                        <input id={`skin-${item.skin}`} className="form-check-input" type="radio"
                                               name="data-skin"
                ...
                <div className="p-3 border-bottom border-dashed">
                    <h5 className="mb-3 fw-bold">Modo de color</h5>
                    <Row className="g-3">
                        {
                            themeOptions.map((item, idx) => (
                                <Col sm={4} key={idx}>
                                    <div className="form-check card-radio">
                                        <input id={`theme-${item.theme}`} className="form-check-input" type="radio"
                                               name="data-bs-theme"
                                               value={item.theme}
                ...
                <div className="p-3 border-bottom border-dashed">
                    <h5 className="mb-3 fw-bold">Color de la barra superior</h5>
                    <Row className="g-3">
                        {
                            topBarColorOptions.map((item, idx) => (
                                <Col sm={4} key={idx}>
                                    <div className="form-check card-radio">
                                        <input id={`topbar-color-${item.color}`} className="form-check-input"
                                               type="radio"
                ...
                <div className="p-3 border-bottom border-dashed">
                    <h5 className="mb-3 fw-bold">Orientación del layout</h5>
                    <Row className="g-3">
                        {
                            orientationOptions.map((item, idx) => (
                                <Col sm={4} key={idx}>
                                    <div className="form-check card-radio">
                                        <input id={`layout-${item.orientation}`} className="form-check-input"
                                               type="radio"
                                               name="data-layout"
                ...
                <div className="p-3 border-bottom border-dashed">
                    <h5 className="mb-3 fw-bold">Color del menú lateral</h5>
                    <Row className="g-3">
                        {
                            sidenavColorOptions.map((item, idx) => (
                                <Col sm={4} key={idx}>
                                    <div className="form-check card-radio">
                                        <input id={`sidenav-color-${item.color}`} className="form-check-input"
                                               type="radio"
                ...
                <div className="p-3 border-bottom border-dashed">
                    <h5 className="mb-3 fw-bold">Tamaño del menú lateral</h5>
                    <Row className="g-3">
                        {
                            sidenavSizeOptions.map((item, idx) => (
                                <Col sm={4} key={idx}>
                                    <div className="form-check card-radio">
                                        <input id={`sidenav-size-${item.size}`} className="form-check-input"
                                               type="radio"
                ...
                <div className="p-3 border-bottom border-dashed">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 className="fw-bold mb-0">Posición del layout</h5>
                                ...
                                layoutPositionOptions.map((item, idx) => (
                                    <Fragment key={idx}>
                                        ...
                                        <label className="btn btn-sm btn-soft-warning w-sm"
                                               htmlFor={`position-${item.position}`}>{toPascalCase(item.position)}</label>
                                    </Fragment>
                                ))
                            }
                        </div>
                ...
                <div className="p-3">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 className="mb-0"><label className="fw-bold m-0" htmlFor="sidebaruser-check">Información del usuario en el menú</label></h5>
